          ...
          <div class="program-row">
            ...
            <div class="about-keynote">
              ...
              <p>
                ...
                focuses on the opportunities and challenges that companies face
                in their digital transformation and it highlights the
                ...
                collaboration with companies in the the embedded systems domain.
              </p>
            </div>
            <span>
              <span class="keynote-speaker">
              ...
              <p>
                ...
                the Department of Computer Science and Media Technology at Malmö
                University, Sweden, and a senior researcher in
                <a
                ...
                and primarily with software-intensive companies in the embedded
                systems domain. Her research interests include engineering
                aspects of AI systems, data driven development practices, data
                management, digital transformation and software and business
                ecosystems.
              </p>
              <a
            ...
            <div class="program-heading">
              <h2>
                Ending Keynote: The Metaverse - will it revolutionize innovation
                and social relations - or bring down our democracies?
              </h2>
            </div>
            <span class="keynote-speaker">
    ...
    <div class="tracks-container">
      ...
      <div class="track">
        ...
        <div class="program-row">
          ...
          <span class="content">
            <p class="program-description">
              Vad är ett programmeringsspråk? Varför kan inte våra verktyg
              skriva koden åt oss? Kan man skriva kod direkt i produktion, och
              vad händer om man gör det? Samt, kan man inte bara kompilera koden
            ...
            <p>
              ...
              programmeringsspråket Dark. Ett språk som utmanar gamla (och i
              vissa fall, förlegade) föreställningar om hur vi utvecklar
        ...
        <div class="program-row">
          ...
          <span class="content">
            <p class="program-description">
              Jag kommer att prata om hur vi på Sartorius använder oss av
              verktyget - Service Blueprint som annars används för
              tjänstedesign, och hur vi använder det för vår mjukvaruutveckling
      ...
      <div class="track">
        ...
        <div class="program-row">
          ...
          <span class="content">
            <p class="program-description">
              Vi ha med hjälp av elektroniska journaler och maskininlärning
              skapat en modell som predikterar hur länge en patient kommer att
      ...
      <div class="track">
        ...
        <div class="program-row">
          ...
          <span class="content">
            <p class="program-description">
              Hur något så torrt som konfiguration kan avgöra den kreativa
              höjden. Hur man hittar en balans för användbarhet, enkelhet och
              ...
              <div class="program-row">
                ...
                <span class="content">
                  <p>
                    ...
                    <br />Förändring är samtidigt nära besläktat med design och
                    utveckling och i vår bransch måste vi alltid se hur vi kan
                    arbeta med design för positiv förändring - dvs god
                    utveckling. <br /><br />Men vilka kompetenser behövs?
                    <br />
                    Och hur kan vi tänka kring utveckling av våra kompetenser?
                    <br />
                    <br />
                    I denna keynote kommer professor Mikael Wiberg att fokusera
                    på designkompetenser i en föränderlig värld utifrån
                    dagsaktuella frågor om specialistkompetenser vs. att vara
                    generalist. Han kommer även belysa vad design- och
                    utvecklingsteam behöver reflektera över vad gäller
                    kompetensförsörjning, inte minst i en tid då såväl
                    teknologier, som samhället och dess behov snabbt förändras.
                  </p>
                  <span class="speaker">
                  ...
                  <div class="program-row">
                    ...
                    <span class="content">
                      <p class="program-description">
                        ...
                        byggda av flertalet microservices. Den här
                        presentationen förklarar sambandet mellan microservices
                        och meddelandeköer. Vi tittar på hur 84codes AB,
                        världens största leverantör av “RabbitMQ as a Service”
                        använder RabbitMQ som kärna i deras arkitekturen.
                      </p>
                      <span class="speaker">
                  ...
                  <div class="program-row">
                    ...
                    <span class="content">
                      <p class="program-description">
                        ...
                        testkod till något som både går snabbare att exekvera,
                        är lättare att förstå och enkelt att lägga till fler
                        exempel till.
                        <br />
                        <br />
                        Om du eller ditt team kommer på er själva att någon gång
                        säga "vi skulle behöva mer tester men det är för jobbigt
                        att skriva fler" eller "nu har jag en fungerande
                        implementation men vet inte hur jag ska testa den" är
                        detta passet för er!
                      </p>
                      <span class="speaker"
                  ...
                  <div class="program-row">
                    ...
                    <span class="content">
                      <p class="program-description">
                        ...
                        blixtföreläsning handlar om hur team kan jobba mer
                        effektivt genom att planera vissa saker på vissa tider.
                      </p>
                  ...
                  <div class="program-row">
                    ...
                    <span class="content">
                      <p class="program-description">
                        ...
                        myndigheter. Det kan vara omöjligt att invänta
                        färdigskrivna lagar innan utvecklingen påbörjas, på
                        grund av kort tid fram till när de ska börja gälla.
                        <br />
                        <br />
                        ...
                        koden som skrivs någonsin kommer att produktionssättas?
                        <br />
                        Roger Nilsson, Product Owner på Skatteverket, berättar
                        om sina erfarenheter från utveckling av en del av
                        innehållet i Januariöverenskommelsen. Från uppgång till
                        fall.
                      </p>
